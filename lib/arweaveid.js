...
class ArweaveID {
    ...
    getAccount(target = this.walletAddress, identiconSize = 120) {
        return __awaiter(this, void 0, void 0, function* () {
            const res = yield this.get({ function: 'get', request: 'account', target });
            res.account.extras = new Map(res.account.extras);
            res.account.identicon = yield this.getIdenticon(target, identiconSize);
            return res.account;
        });
    }
    ...
    getIdenticon(target = this.walletAddress, size = 120) {
        return __awaiter(this, void 0, void 0, function* () {
            const canvas = canvas_1.createCanvas(size, size, 'svg');
